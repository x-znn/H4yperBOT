...
const stickernobg = (query) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/removebgwithurl?link=${query}&apikey=Fauzann99`)
...
const its = (query) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/igstory?query=${query}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const linesticker = () => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/newsticker?apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const lirik = (query) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/liriklagu?query=${query}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const kbbi = (word) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/kbbi?query=${word}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const distance = (from, to) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/distance?from=${from}&to=${to}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const gsmarena = (model) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/gsmarena?query=${model}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const resep = (food) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/resepmasakan?query=${food}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const sticker = (query) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/wasticker?query=${query}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const ytSearch = (query) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/youtube?query=${query}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const playstore = (query) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/playstore?query=${query}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const shopee = (query, count) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/shopee?query=${query}&count=${count}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const listSurah = () => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/quranlist?&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const getSurah = (surah) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/quran?no=${surah}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const ytPlay = (query) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/ytmp3?query=${query}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const whois = (ip) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/ipwhois?ipaddr=${ip}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const movie = (title) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/downloadfilm?judul=${title}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const ongkir = (courier, from, to) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/cekongkir?kurir=${courier}&fromcity=${from}&tocity=${to}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
