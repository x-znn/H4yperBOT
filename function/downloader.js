...
const insta = (url) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/instadl?link=${url}&apikey=Fauzann99`)
...
const tik = (url) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/tiktokdl?link=${url}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const fb = (url) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/fbdl?link=${url}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const joox = (title) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/music?query=${title}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
/**
 * Get TikTok no wm video from URL.
 * @param {string} url 
 * @returns {Promise<object>} 
 */
const tiknowm = (url) => new Promise((resolve, reject) => {
    console.log(`Get TikTok media from ${url}`)
    fetchJson(`https://api.vhtear.com/tiktok_no_wm?link=${url}&apikey=Fauzann99`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
